...
# TOKEN_DURACION_MINUTOS = 10080  # 7 días
#
# # Dominio raíz configurable por entorno
# # Ejemplo:
# # PORTAL_ROOT_DOMAIN=talentum-manager.com
# PORTAL_ROOT_DOMAIN = os.getenv("PORTAL_ROOT_DOMAIN", "talentum-manager.com").strip()
#
# # Opcional: permitir override completo si alguna agencia maneja otro dominio
# # Ejemplo:
# # PORTAL_BASE_URL=https://app.midominio.com/portal
# PORTAL_BASE_URL = os.getenv("PORTAL_BASE_URL", "").strip()
#
#
# # =========================================================
...
# def obtener_tenant_actual() -> str:
#     """
#     Obtiene el tenant actual desde ContextVar.
#     Si no existe o viene vacío, usa 'public'.
#     """
#     try:
#         tenant = current_tenant.get()
#     except Exception:
#         tenant = "public"
#
#     tenant = (tenant or "public").strip().lower()
#     return tenant
#
#
# def construir_base_portal_url() -> str:
#     """
#     Construye dinámicamente la URL base del portal según el tenant actual.
#
#     Casos:
#     - tenant = test   -> https://test.talentum-manager.com/portal
#     - tenant = acme   -> https://acme.talentum-manager.com/portal
#     - tenant = public -> https://talentum-manager.com/portal
#     - si PORTAL_BASE_URL está definida, la usa tal cual
#     """
#     if PORTAL_BASE_URL:
#         return PORTAL_BASE_URL.rstrip("/")
#
...
#
# def construir_url_portal(token: str) -> str:
#     base_portal_url = construir_base_portal_url()
