...
from main_invitacion import (
    InvitacionPortalOut,
    obtener_invitacion_portal_por_aspirante,
)
from utils_aspirantes import (
    construir_url_actualizar_perfil,
    actualizar_uso_token,
    resolver_token_portal_general_o_error,
)
from urllib.parse import urlparse, parse_qs, urlencode, urlunparse, quote

from portal_access_tokens import obtener_tenant_actual, construir_url_agendamiento
...
# =========================================================
# HELPERS RESOLVER TOKEN PORTAL ASPIRANTE
# =========================================================
        ...
        with conn.cursor() as cur:
            cur.execute(
                ...
                WHERE pat.token = %s
                  ...
                  AND COALESCE(pat.tipo_portal, 'aspirante') = 'aspirante'
                LIMIT 1
                """,
                (token,),
            )
            ...
            if row[6] == ESTADO_ASPIRANTE_RECHAZADO:
                raise HTTPException(
                    status_code=403,
                    detail=(
...
# =========================================================
# ENDPOINT CITAS PORTAL ASPIRANTE
# =========================================================
...
# =========================================================
# ENDPOINT GENERAL VALIDAR PORTAL
# =========================================================
