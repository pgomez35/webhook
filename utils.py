...
def descargar_audio(audio_id, token, carpeta_destino=AUDIO_DIR):
    """
    1) Consulta a Meta el media URL del audio_id
    2) Descarga el archivo .ogg
    3) Sube a Cloudinary
    4) Retorna secure_url
    """
    try:
...
# -------------------------------------------------------------------
# TOKEN Y WABA_ID (temporal en memoria)
# -------------------------------------------------------------------
...
def clear_temp_waba_id():
    tokens_temporales["ultimo_waba_id"] = None
...
# -------------------------------------------------------------------
# META: phone_numbers + partner event
# -------------------------------------------------------------------
